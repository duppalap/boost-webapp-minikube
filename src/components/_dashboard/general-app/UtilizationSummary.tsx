...
export default function UtilizationSummary(props: UtilizationSummaryProps) {
  ...
  const UTILIZATION_SUMMARY_ICONS: UtilizationSummaryItem[] = [
    ...
    },
    {
      ...
      icon: (
        <Icon
          icon="icon-park-outline:energy-socket"
          color="#004d40"
          {...ICON_SIZE}
        />
      ),
    },
    {
      ...
      icon: (
        <Icon icon="mdi:battery-charging-100" color="#1C9CEA" {...ICON_SIZE} />
      ),
    },
    {
    ...
    },
    {
      ...
      icon: (
        <Icon icon="mdi:battery-charging-60" color="#c62828" {...ICON_SIZE} />
      ),
    },
    {
      ...
      icon: (
        <Icon
          icon="ic:baseline-battery-charging-90"
          color="#4caf50"
          {...ICON_SIZE}
        />
      ),
  ...
  return (
    <Stack sx={{ marginTop: 2 }} spacing={2}>
            ...
            {loadingSummary ? (
              ...
              <React.Fragment>
                {utilizationSummary.map((site) => {
                  let obj = UTILIZATION_SUMMARY_ICONS.find(
                    (o) => o.name === site.name
                  );
      ...
      <Paper sx={style}>
        ...
        >
          Data is cumulated over the last 30 days as default. Please select a
          date range above to update the charts
        </Typography>
        <ShadowCard sx={{ boxShadow: systemShadows[6] }}>
